       ...
       SegedUpgradeTower=null;*/
        if (OwnArrowTowerStb == 1)
        {
            ...
            if (Level == 1)
            {
                ...
                Tower.GetComponent<TowerShot>().timerMax /= 1.4f;
                ...
                if (Level == 2)
            {
                ...
                if (Index == 1)
                {
                    ...
                    Tower.GetComponent<TowerShot>().timerMax *= 1.25f;
                    //Tower.GetComponent<TowerShot>().range += 0.7f;
            ...
            if (Level == 3)
            {
                 ...
                 if (Index == 2)
                {
                    ...
                    Tower.GetComponent<TowerShot>().kepsseg1 += 4;
            ...
            if (Level == 4)
            {
                ...
                if (Index == 2)
                {
                    ...
                    if(Tower.GetComponent<TowerShot>().kepsseg2==0)
                    {
                        Tower.GetComponent<TowerShot>().kepsseg2=2;
                    }
                    else
                ...
                if (Index == 3)
                {
                    ...
                    if(Tower.GetComponent<TowerShot>().kepsseg3==0)
                    {
                        Tower.GetComponent<TowerShot>().kepsseg3 += 3;
                    }
                    else
                    {
                        Tower.GetComponent<TowerShot>().kepsseg3 += 5;
                    }
                }
            }
        }
            ...
            if (OwnArrowTowerStb == 2)
        {
            ...
            if (Level == 1)
            {
                ...
                if (Index == 1)
                {
                    ...
                    int pluszDamage = 8, pluszHP = 110;
                    float pluszspeed=1.17f;
                    ...
                    Tower.GetComponent<TowerOwnSolderBuilding>().pluszspeed = pluszspeed;
                    for (int i = 0; i < Tower.GetComponent<TowerOwnSolderBuilding>().AllSoldier.Count; i++)
                    {
                        ...
                        Tower.GetComponent<TowerOwnSolderBuilding>().AllSoldier[i].GetComponent<SoldiersMove>().realodingTime /= pluszspeed;
