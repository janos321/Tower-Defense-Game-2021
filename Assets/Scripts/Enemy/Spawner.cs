...
public class Spawner : MonoBehaviour
{
    ...
    public void waveneveze(string szam)
    {
        if (database.LNG == "EN")
        {
            waveCountText.GetComponent<Text>().text = "Wave: " + WavesDifficulti[LoadAnotherScene.ForceSojdan - 1].WavesCount.Count.ToString()+"/"+szam;
        }
        else
       if (database.LNG == "HU")
        {
            waveCountText.GetComponent<Text>().text = "Hullám: " + WavesDifficulti[LoadAnotherScene.ForceSojdan - 1].WavesCount.Count.ToString() + "/" + szam;
        }
        else
       if (database.LNG == "SR")
        {
            waveCountText.GetComponent<Text>().text = "Talas: " + WavesDifficulti[LoadAnotherScene.ForceSojdan - 1].WavesCount.Count.ToString() + "/" + szam;
        }
        else
       if (database.LNG == "DE")
        {
            waveCountText.GetComponent<Text>().text = "Welle: " + WavesDifficulti[LoadAnotherScene.ForceSojdan - 1].WavesCount.Count.ToString() + "/" + szam;
        }
    }
    void Update()
    {
    ...
    IEnumerator WaveComing()
    {
        ...
        else
        {
            ...
            if (HeartCounter.BeginnerHeart != 0&&!AllGameObject.GameOverCanvas.active)
            {
                ...
                {
                    yellowDiamond += (a - (database.MAP[AllGameObject.LevelCount - 1] - (LoadAnotherScene.ForceSojdan - 1) * 3)) * 20;
    ...
    public void LoadingNextWaveButtonDepression()
    {
        ...
        KetWaveKozottiIdo = 0;
        //waveCountText.GetComponent<Text>().text = WavesDifficulti[LoadAnotherScene.ForceSojdan - 1].WavesCount.Count.ToString()+'/'+ waveCount.ToString();
    }
}
