...
public class HeroPicAnimation : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            prezent = gameObject.GetComponent<CLassicHEroScript>().Direction;
            ImageSkipTimeAttack = 2 * gameObject.GetComponent<CLassicHEroScript>().realodingTime;
            ImageSkipTimeWalk = gameObject.GetComponent<CLassicHEroScript>().SoldiersSpeed;
